...
import { sendResetEmail } from "../middleware/auth.mailer.js";
import ForgotPassword from "../models/forgot.password.modal.js";
...
// set new password
export const newPasswordSet = async (req, res) => {
  try {
