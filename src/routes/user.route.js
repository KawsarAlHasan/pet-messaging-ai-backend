...
import { changePassword, getMyProfile, loginUser, signupUser, updateProfile } from "../controllers/user.controller.js";
...
router.patch("/update-profile", uploadImage.single("profilePicture"), verifyUserToken, updateProfile);
